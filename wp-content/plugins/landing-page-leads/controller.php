...
class Controller {
	...
	public function add_menu() {
		...
		add_menu_page('Landing Page Leads - List', 'Leads Records - lp1', 'manage_options', $this->slug['list'], array($this, list_all));

		add_submenu_page(null, 'Landing Page Leads - Add New', 'Add New', 'manage_options', $this->slug['add'], array($this, add_new));

		add_submenu_page($this->slug['list'], 'Landing Page Leads - Settings', 'Settings', 'manage_options', $this->slug['settings'], array($this, settings));

		add_submenu_page(null, 'Landing Page Leads - Edit', 'Edit', 'manage_options', $this->slug['edit'], array($this, edit));
