				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-4">
						...
						<div class="row">
							...
							<form class="bannerform" onSubmit="return checkQuoteForm()" method="post">
							...
							<div class="col-xs-12 col-sm-12">
								...
								<textarea name="quote_comment" id="quote_comment" placeholder="Comments asd" onBlur="checkField('quote_comment','span_quote_comment','normal')"></textarea>
