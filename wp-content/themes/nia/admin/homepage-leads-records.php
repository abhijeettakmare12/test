...
class Homepage_Functionality {
  ...
  public function enqueue_scripts() {
	  ...
	  //wp_enqueue_script( "admin_file", 'admin/js/homepage_admin_export.js', array( 'jquery' ) );
...
public function request_data_page_handler()
	{
    	 global $wpdb;
//require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/homepage-admin-list-data.php';
include(TEMPLATEPATH . '/admin/homepage-admin-list-data.php');
//include( 'admin/homepage-admin-list-data.php' );
    $table = new homepage_request_table_list();
    $table->prepare_items();
